...
function RenderCategoriesBar() {
  ...
  return (
    <div className="container-fluid" style={{backgroundColor: "#F8A5B9", height: "2.5rem", margin: "0", display: "flex", justifyContent: "center", alignItems: "center"}} >
     <Link to="/category/dermocosmetica" style={{color: '#2F2F2F', fontWeight: '495', padding: '15px'}} >Cosméticos</Link>
      <Link to="/category/cuidado personal" style={{color: '#2F2F2F', fontWeight: '495', padding: '15px'}} >Cuidado personal</Link>
